public class VoltageCalculator2 {

    public static double computeVoltage(int resistance,int extra) {
        int current = 22;
        ...
        while (adjusted < resistance && extra < adjusted) {
            extra += 2;
        }
        ...
        if (adjusted > 60) {
            ...
            if (resistance != 0) {
                ...
                voltage = (adjusted + extra) / divisor;
            } else {
                adjusted = adjusted + 6;
                voltage = adjusted * 2;
                stable = false;
